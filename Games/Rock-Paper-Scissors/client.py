...
top = Tk()
top.title("Rock Paper Scissors (client)")
...
def checkResult():
    if myRespond == opponentRespond:
        ...
        if opponentRespond == "scissors":
            win("Rock smashes scissors! client win!")
        else:
            win("Paper covers rock! client lose.")
    elif myRespond == "paper":
        if opponentRespond == "rock":
            win("Paper covers rock! client win!")
        else:
            win("Scissors cuts paper! client lose.")
    elif myRespond == "scissors":
        if opponentRespond == "paper":
            win("Scissors cuts paper! client win!")
        else:
            win("Rock smashes scissors! client lose.")
